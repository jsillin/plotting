...
for i in range(2,120):
    ...
    #purple = mpatches.Patch(color='purple',label='Frontogenesis')
    ...
    leg.set_zorder(100)
    #leg2 = ax1.legend(handles=[grey_line,blue_line],title='Map Legend',loc=3,framealpha=1)

    plt.savefig(output_dir+'/GFS/gfs_hrly_pytpesound_cape_3_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    fcst_hr = str(0)
    plt.close()
    plt.clf()
    '''
