    ...
    if cape==True:
        for k in range(len(plot_elevs)):
            ...
            for i in range(s,r):
                ...
                lcl_pressure, lcl_temperature = mpcalc.lcl(sound_pres[0], sound_temps.data[0]*units.degC, sound_dp[0])
                ...
                skew.ax.annotate(str(round(lcl_pressure.m,0))+'mb', (0.1, -0.1))
        ...
        for k in range(len(plot_elevs)):
            ...
            for i in range(s,r):
                ...
                #skew.ax.axvspan(-18, -12, color='gold', alpha=0.5)
                skew.plot(lcl_pressure, lcl_temperature, 'ko', markerfacecolor='forestgreen')
                skew.ax.annotate(lcl_pressure, (sound_temps, sound_dp))
                skew.ax.set_ylim((1000,300))
                skew.ax.axis('off')
