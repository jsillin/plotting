...
import gfs_soundingmaps as smap
...
for i in range(0,120):
    ...
    smap.plot_soundings(fig,ax1,data['temperature'],data['rh'],36.9,87.5,'regional',cape=True)
    ...
    ######## Save the plot
    plt.savefig(output_dir+'/GFS/GFS_TEST_V6_hrly_pytpe_hop_sound_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    fcst_hr = str(0)
    plt.close()
    plt.clf()
