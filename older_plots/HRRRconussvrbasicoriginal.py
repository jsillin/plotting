...
#This helper function will be used to create a new directory to store data
def mkdir_p(mypath):
...
for i in range(0,18):
    ...
    ax.set_extent((240, 288, 25, 50), crs = cartopy.crs.PlateCarree())
    ...
    plt.savefig(output_dir+'/HRRR_CONUS/hrrrconuscaperadar'+time[0].dt.strftime('%Y-%m-%d %H%M').item()+'.png')
    fcst_hr = str(i*1)
