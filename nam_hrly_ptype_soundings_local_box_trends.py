...
for i in range(0,26):
    ...
    ax1.set_extent((286, 290, 40.5, 43.75))#, crs = zH5_crs)    # Set a title and show the plot
    ...
    leg.set_zorder(500)
    plt.savefig(output_dir+'/NAM/nam_hrly_pytpe_box_sound_trend_v1_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    fcst_hr = str(0)
    plt.close()
    plt.clf()
    '''
