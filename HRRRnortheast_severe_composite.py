...
for i in range(0,18):
    ...
    ax.set_extent((270, 292, 38, 48), crs = cartopy.crs.PlateCarree())
    ...
    plt.savefig(output_dir+'/HRRR_NE/hrrr_northeast_svr_composite_mslp'+time[0].dt.strftime('%Y-%m-%d %H%M').item()+'.png')
    fcst_hr = str(i*1)
