...
for i in range(1,121):
    ...
    leg.set_zorder(100)
    plt.savefig(output_dir+'/GFS/ec_h7fgen_'+dtfs+'.png')
    ax.set_extent((281,295,39,49))
    plt.savefig(output_dir+'/GFS/ne_h7fgen_'+dtfs+'.png')
    ...
    leg.set_zorder(100)
    plt.savefig(output_dir+'/GFS/ec_h8fgen_'+dtfs+'.png')
    ax2.set_extent((281,295,39,49))
    plt.savefig(output_dir+'/GFS/ne_h8fgen_'+dtfs+'.png')
    ...
    leg.set_zorder(100)
    plt.savefig(output_dir+'/GFS/ec_h9fgen_'+dtfs+'.png')
    ax3.set_extent((281,295,39,49))
    plt.savefig(output_dir+'/GFS/ne_h9fgen_'+dtfs+'.png')
    ...
    plt.savefig(output_dir+'/GFS/ec_fgencomp_'+dtfs+'.png')
    ax4.set_extent((281,295,39,49))
    plt.savefig(output_dir+'/GFS/ne_fgencomp_'+dtfs+'.png')
    print(dtfs+' done')
