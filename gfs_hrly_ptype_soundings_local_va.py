...
for i in range(2,120):
    ...
    ax1.set_extent((280, 284, 36.375, 39.625))#, crs = zH5_crs)    # Set a title and show the plot
    ...
    sound_lats = [soundlat+0.2,soundlat+0.7,soundlat+1.2,soundlat+1.75,soundlat+2.25,soundlat+2.8]
    for i in range(1,r):
    ...
    leg.set_zorder(500)
    plt.savefig(output_dir+'/GFS/gfs_hrly_pytpe_va_sound_3_'+dtfs+'.png',bbox_inches='tight',pad_inches=0.1)
    fcst_hr = str(0)
    plt.close()
    plt.clf()
    '''
